...
\begin{entry}
  ...
  \item Implementing a software library that transparently replaces domain sockets by injecting a custom shared memory transmission channel.
  \item This can speed up a variety of applications by an order of magnitude.
  \item Currently more than 7000 lines of low level system programming in C, on Linux.
\end{entry}
...
\begin{entry}
  ...
  \item 4\textsuperscript{th} place in state philosophy contest. Making the case for healthy inequality from a capitalist standpoint.
...
\begin{entry}
  ...
  \begin{itemize}
    ...
    \item Top 5\% in every course in first semester.
  ...
  \begin{itemize}
    ...
    \item Introduction to Computer Networks and Distributed Systems.
    \item Computer Architecture Practicum.
    \item Linear Algebra.
    \item Data-Mining Seminar (Topic: Deep Learning with TensorFlow).
  \end{itemize}
\end{entry}
\begin{entry}{Online Education}{}{07/2013 --- Present}
...
\begin{simpleentry}
  \item \emph{Non-Intrusive Load Monitoring: A Review and Outlook} (2016) with Christoph Klemenjak. To be published in the proceedings of annual conference of the \emph{Gesellschaft für Informatik}. I will be presenting at \emph{SKILL Studierendenkonferenz} in Klagenfurt, Austria on September 30th 2016.
  \item \emph{A Tour of TensorFlow} (2016), published as part of the Data Mining Seminar at TUM.
\end{simpleentry}
...
\section{Certifications}{1.6}{0.4}
\begin{simpleentry}
...
\section{Interests}{1.6}{0.4}
\begin{simpleentry}
  \item International politics and diplomacy
  \item Philosophy and differing schools of thought
  \item Capitalism, Libertarianism, Objectivism
  \item Discussing why the above are the only moral ways of structuring society, economies and one's life
