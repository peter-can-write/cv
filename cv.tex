...
\begin{entry}
	...
	{\\Intern, gTech Team}
	{08/2016 --- 11/2016}
  \item Developed a web platform to interactively showcase Google’s ad technologies.
  \item Worked on an internal chatbot system that makes remote procedure calls to an internal issue tracker to allow natural language bug queries.
  \item Open-sourced an integration of the Google Publisher Tags library with Angular under an official Google GitHub repo.
