...
\begin{itemize}
  ...
  \item \link{clang-expand}{https://github.com/goldsborough/clang-expand} is a clang and LLVM based tool to inline function calls and expand macros in C, C++ and Objective-C for visual benefit and easier refactoring. Featured in LLVM weekly: \link{http://llvmweekly.org/issue/169}{http://llvmweekly.org/issue/169}
...
\end{entry}
\begin{entry}{\link{TU Investment Club}{https://tuinvest.de}}{}{10/2015 --- Present}
...
\begin{simpleentry}
  \item \emph{Non Intrusive Load Monitoring: A Review and Outlook}, Christoph Klemenjak, Peter Goldsborough, Sep. 2016 --- \link{arXiv:1610.01191}{https://arxiv.org/abs/1610.01191}
