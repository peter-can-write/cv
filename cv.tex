...
\begin{entry}
  ...
  \item Currently more than 10,000 lines of low level system programming in C, on Linux.
\end{entry}
...
\item Applied machine-learning and data-science techniques to make NIALM
